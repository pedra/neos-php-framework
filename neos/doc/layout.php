...
class Layout
	...
	*/
	...
	function __construct(){
		...
		define('URLT', _app('URL') . \_cfg::this()->template_url . '/' . \_cfg::this()->template . '/' );
		define('PATH_TEMPLATE',	\_cfg::this()->template_path . \_cfg::this()->template . DS . 'engine' . DS );
...
<head>
	...
	function __footer(){
		...
		$app = _app();
		if($app && (\_cfg::this()->jsfw->active==true)){
					$js .= "\n\t" . '<script type="text/javascript">/*<![CDATA[*/';
					foreach($app as $ak=>$av){$js .= "var " . \_cfg::this()->jsfw->prefix . $ak . '="' . $av . '";';}
					$js .= '/*]]>*/</script>' . "\n";
				}
