...
$cfg->out_filter			= true;   //ativa a filtragem da saida para "head" e "body"
...
$cfg->admin_url				= 'neoscoreadmin'; //'neoscoreadmin';
$cfg->admin_controller		= 'control';

//REPORT
$cfg->mode					= 'test';    //pode ser production ou test (desenvolvimento)
$cfg->status				= 'displayfile';    //mostra a barra de status - opções: 'displayfile'
$cfg->error['action']		= 'displayfile'; //ação em caso de erro - opções: 'displayfileroutemail'
